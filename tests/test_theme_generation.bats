...
checks = {
    ...
    r'^\s+float_border_fg = "#c5c8c6",$': 'ui float_border_fg',
    ...
    r'^\s+msg_separator_fg = "#c5c8c6",$': 'ui msg_separator_fg',
    r'^\s+pmenu_bg = "#1d1f21",$': 'ui pmenu_bg',
    r'^\s+pmenu_fg = "#c5c8c6",$': 'ui pmenu_fg',
    r'^\s+pmenu_sel_bg = "#373b41",$': 'ui pmenu_sel_bg',
    ...
    r'^\s+split_fg = "#c5c8c6",$': 'ui split_fg',
