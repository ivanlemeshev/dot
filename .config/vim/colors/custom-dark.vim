...
let s:bg4             = '#4F4A45'
let s:bg5             = '#655D57'
let s:bg_statusline1  = '#3A322D'
let s:bg_statusline2  = '#423C38'
let s:bg_statusline3  = '#5A524D'
let s:bg_visual_red   = '#493B40'
let s:bg_visual_yellow = '#45443C'
let s:bg_visual_green = '#3C4841'
let s:bg_visual_blue  = '#384B55'
let s:bg_visual_purple = '#463F48'
let s:bg_diff_red     = '#E67E80'
let s:bg_diff_green   = '#A7C080'
let s:bg_diff_blue    = '#7FBBB3'
let s:bg_current_word = '#45403C'
let s:fg0             = '#d4b98d'
let s:fg1             = '#ddc296'
let s:red             = '#E67E80'
let s:orange          = '#E69875'
...
let s:purple          = '#D699B6'
let s:bg_red          = '#E67E80'
let s:bg_green        = '#A7C080'
let s:bg_yellow       = '#DBBC7F'
let s:grey0           = '#806E5A'
let s:grey1           = '#968169'
let s:grey2           = '#AE9775'
