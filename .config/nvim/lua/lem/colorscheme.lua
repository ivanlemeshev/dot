...
function M.setup()
  ...
  hl("@text.danger", { fg = p.base00, bg = p.base08 })
  hl("@text.emphasis", { italic = true })
  hl("@text.note", { fg = p.base07, bg = p.base0E })
  hl("@text.strong", { bold = true })
  hl("@text.underline", { underline = true })
  hl("@text.uri", { fg = p.base0D, underline = true })
  hl("@text.warning", { fg = p.base00, bg = p.base0A })
  hl("@uri", { fg = p.base0D, underline = true })
  ...
  link("@include.go", "Purple")
  link("@namespace.go", "Fg")
  link("@module.go", "Fg")
