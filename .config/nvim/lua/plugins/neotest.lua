return {
  ...
  keys = {
    { "<leader>tt", desc = "Neotest: run the test" },
    { "<leader>tf", desc = "Neotest: run the test file" },
    { "<leader>tp", desc = "Neotest: toggle the test output panel" },
    { "<leader>ts", desc = "Neotest: toggle the test summary" },
  },
  opts = {},
  config = function()
