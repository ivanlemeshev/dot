...
Choose one task → edit on a branch → verify → update [TODO.md](TODO.md).
Keep one to three tasks in Next and future ideas in Later.
...
3. `/lem-review-pr`: review the diff before a commit.
