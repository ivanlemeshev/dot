...
for line in [
    ...
    '-- \x60WhichKeyNormal\x60 is the popup background and text area.',
    'hl("WhichKeyNormal", { fg = M.ui.fg, bg = M.ui.bg })',
    '-- \x60WhichKeyBorder\x60 is the popup border.',
    'hl("WhichKeyBorder", { fg = M.ui.fg, bg = M.ui.bg })',
    '-- \x60WhichKeyTitle\x60 labels the popup title.',
    'hl("WhichKeyTitle", { fg = M.ui.fg, bg = M.ui.bg })',
    '-- \x60WhichKeyGroup\x60 marks grouped key prefixes.',
    'hl("WhichKeyGroup", { fg = M.ui.fg, bg = M.ui.bg })',
    '-- \x60WhichKeyDesc\x60 marks mapping descriptions.',
    'hl("WhichKeyDesc", { fg = M.ui.fg, bg = M.ui.bg })',
    '-- \x60WhichKeySeparator\x60 separates keys from descriptions.',
    'hl("WhichKeySeparator", { fg = M.ui.fg, bg = M.ui.bg })',
    '-- \x60WhichKeyValue\x60 shows plugin-provided values.',
    'hl("WhichKeyValue", { fg = M.ui.fg, bg = M.ui.bg })',
    '-- ============================================================================',
    '-- Syntax',
    '-- ============================================================================',
    '-- \x60Function\x60 is used for function names, like \x60print\x60 or \x60map\x60.',
    'hl("Function", { fg = M.syntax["function"] })',
    '-- \x60Keyword\x60 is used for reserved words, like \x60function\x60, \x60local\x60, or \x60end\x60.',
    'hl("Keyword", { fg = M.syntax.keyword })',
    '-- \x60Type\x60 is used for type names, like \x60int\x60, \x60String\x60, or \x60MyStruct\x60.',
    'hl("Type", { fg = M.syntax.type })',
    '-- \x60Todo\x60 is used for TODO/FIXME-style markers, like \x60TODO\x60, \x60FIXME\x60, or \x60XXX\x60.',
    'hl("Todo", { fg = M.syntax.constant, bold = true })',
    '-- ============================================================================',
    '-- Treesitter',
    '-- ============================================================================',
    '-- \x60@variable\x60 matches variable-like identifiers, like \x60foo\x60, \x60count\x60, or \x60result\x60.',
    'hl("@variable", { fg = M.syntax.variable })',
    '-- \x60@function.call\x60 matches function call sites, like \x60print(x)\x60 or \x60foo(bar)\x60.',
    'hl("@function.call", { fg = M.syntax["function"] })',
    '-- \x60@keyword.conditional\x60 matches conditionals, like \x60if\x60, \x60else\x60, and \x60elseif\x60.',
    'hl("@keyword.conditional", { fg = M.syntax.keyword })',
    '-- \x60@comment.todo\x60 matches TODO-style comments, like \x60TODO\x60, \x60FIXME\x60, or \x60XXX\x60.',
    'hl("@comment.todo", { fg = M.syntax.comment, bold = true })',
    '-- \x60@markup.heading.1\x60 matches top-level headings, like \x60# Title\x60.',
    'hl("@markup.heading.1", { fg = M.syntax.type, bold = true })',
    '-- \x60@diff.plus\x60 matches added text, like a line prefixed with \x60+\x60.',
    'hl("@diff.plus", { fg = M.syntax.constant })',
    '-- \x60@tag.delimiter\x60 matches XML/HTML-style tag delimiters, like \x60<\x60, \x60>\x60, or \x60</\x60.',
