...
-- Buffers
map("n", "<leader>w", "<cmd>w<CR>", { desc = "Save the current buffer", noremap = true, silent = true })
...
-- Resize panes
map("n", "<Up>", ":resize -1<CR>", { desc = "Resize the pane up", noremap = true, silent = true })
map("n", "<Down>", ":resize +1<CR>", { desc = "Resize the pane down", noremap = true, silent = true })
map("n", "<Left>", ":vertical resize -1<CR>", { desc = "Resize the pane left", noremap = true, silent = true })
map("n", "<Right>", ":vertical resize +1<CR>", { desc = "Resize the pane right", noremap = true, silent = true })
...
-- vim.pack
map("n", "<leader>Pu", ":lua vim.pack.update()<CR>", { desc = "Plugins: update", noremap = true, silent = true })
