...
map("n", "<leader>pv", vim.cmd.Ex, { desc = "Back to netrw from the current buffer", silent = true })
...
map("n", "N", "Nzzzv", { desc = "Move to the previous search result", noremap = true, silent = true })
...
-- Panes management
map("n", "<leader>v", "<C-w>v", { desc = "Split the pane vertically", noremap = true, silent = true })
map("n", "<leader>h", "<C-w>s", { desc = "Split the pane horizontally", noremap = true, silent = true })
map("n", "<leader>se", "<C-w>=", { desc = "Equalize the pane sizes", noremap = true, silent = true })
map("n", "<leader>xs", ":close<CR>", { desc = "Close the currrent pane", noremap = true, silent = true })

-- Navigate between panes
map("n", "<C-k>", ":wincmd k<CR>", { desc = "Move to the pane above", noremap = true, silent = true })
map("n", "<C-j>", ":wincmd j<CR>", { desc = "Move to the pane below", noremap = true, silent = true })
map("n", "<C-h>", ":wincmd h<CR>", { desc = "Move to the pane on the left", noremap = true, silent = true })
map("n", "<C-l>", ":wincmd l<CR>", { desc = "Move to the pane on the right", noremap = true, silent = true })

-- Resize panes
map("n", "<Up>", ":resize -2<CR>", { desc = "Resize the pane up", noremap = true, silent = true })
map("n", "<Down>", ":resize +2<CR>", { desc = "Resize the pane down", noremap = true, silent = true })
map("n", "<Left>", ":vertical resize -2<CR>", { desc = "Resize the pane left", noremap = true, silent = true })
map("n", "<Right>", ":vertical resize +2<CR>", { desc = "Resize the pane right", noremap = true, silent = true })
