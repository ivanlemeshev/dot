...
call s:hl('Conditional',  s:diagnostic_error, '',      'italic')
call s:hl('Repeat',       s:diagnostic_error, '',      'italic')
call s:hl('Keyword',      s:diagnostic_error, '',      'italic')
call s:hl('Typedef',      s:diagnostic_error, '',      'italic')
call s:hl('Exception',    s:diagnostic_error, '',      'italic')
call s:hl('Statement',    s:diagnostic_error, '',      'italic')
...
call s:hl('Special',      s:syntax_type, '')
call s:hl('SpecialChar',  s:syntax_type, '')
