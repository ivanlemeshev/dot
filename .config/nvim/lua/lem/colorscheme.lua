...
M.palette = {
  ...
  bg4 = "#4F4A45",
  bg5 = "#655D57",
  bg_statusline1 = "#3A322D",
  bg_statusline2 = "#423C38",
  bg_statusline3 = "#5A524D",
  bg_visual_red = "#493B40",
  bg_visual_yellow = "#45443C",
  bg_visual_green = "#3C4841",
  bg_visual_blue = "#384B55",
  bg_visual_purple = "#463F48",
  bg_diff_red = "#E67E80",
  bg_diff_green = "#A7C080",
  bg_diff_blue = "#7FBBB3",
  bg_current_word = "#45403C",
  fg0 = "#d4b98d",
  fg1 = "#ddc296",
  red = "#E67E80",
  orange = "#E69875",
