...
M.palette = {
  -- Backgrounds
  bg = "#232b30", -- main background
  bg_alt = "#333b40", -- lighter bg: cursor line, statusline, pmenu
  bg_sel = "#434b50", -- selection / visual background
  -- Foregrounds / greys
  faint = "#373f44", -- barely visible: non-printable chars
  muted = "#81837e", -- comments, line numbers, faded
  dim = "#92928b", -- dark foreground: inactive UI
  border = "#5a656f", -- split borders: matches tmux pane border
  fg = "#ece7d6", -- default foreground
  fg_alt = "#f2eedc", -- light foreground: selected item backgrounds
  bright = "#f8f4e3", -- bright white
  -- Colors
  red = "#e67e80",
  orange = "#eb937b",
  yellow = "#f8c46f",
...
function M.setup()
  ...
  hl("OctoGrey", { fg = p.dim })
  hl("OctoViewer", { fg = p.fg_alt, bold = true })
  hl("OctoBubble", { fg = p.fg, bg = p.bg_alt })
  hl("OctoBubbleGreen", { fg = p.green, bg = p.bg_sel, bold = true })
  hl("OctoBubbleRed", { fg = p.red, bg = p.bg_sel, bold = true })
  hl("OctoBubblePurple", { fg = p.magenta, bg = p.bg_sel, bold = true })
  hl("OctoBubbleYellow", { fg = p.yellow, bg = p.bg_sel, bold = true })
  hl("OctoBubbleBlue", { fg = p.blue, bg = p.bg_sel, bold = true })
  hl("OctoGreenFloat", { fg = p.green, bg = p.bg_alt })
  hl("OctoRedFloat", { fg = p.red, bg = p.bg_alt })
  hl("OctoPurpleFloat", { fg = p.magenta, bg = p.bg_alt })
  hl("OctoGreyFloat", { fg = p.dim, bg = p.bg_alt })
  ...
  link("OctoStatusModified", "OctoBlue")
  link("OctoStatusRenamed", "OctoBlue")
  link("OctoStatusCopied", "OctoBlue")
  link("OctoStatusTypeChange", "OctoBlue")
  link("OctoStatusUnmerged", "OctoBlue")
